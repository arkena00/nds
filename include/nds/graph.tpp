...
namespace nds::internal
{
    ...
    auto graph<graph_nodes<Ts...>, graph_edges<Es...>, graph_rules<edge<Us, Vs>...>, graph_storages::tuple_vector>
    ::add(T v)
    {
    ...
    void graph<graph_nodes<Ts...>, graph_edges<Es...>, graph_rules<edge<Us, Vs>...>, graph_storages::tuple_vector>
    ...
    ::add_arc(node_ptr<Source_type> source_, node_ptr<Target_type> target_)
    {
        ...
        std::get<type_index>(edges_).emplace_back(edge<node_ptr<Source>, node_ptr<Target>, Edge_type>{ source, target, edge_type });
    }
    template<class... Ts, class... Es, class... Us, class... Vs>
    ...
    template<class... Ts, class... Es, class... Us, class... Vs>
    std::size_t graph<graph_nodes<Ts...>, graph_edges<Es...>, graph_rules<edge<Us, Vs>...>, graph_storages::tuple_vector>
    ::count_nodes() const
    {
    ...
    template<class... Ts, class... Es, class... Us, class... Vs>
    constexpr std::size_t graph<graph_nodes<Ts...>, graph_edges<Es...>, graph_rules<edge<Us, Vs>...>, graph_storages::tuple_vector>
    ::count_nodes_type()
    {
        return sizeof...(Ts);
    }
    ...
    template<class... Ts, class... Es, class... Us, class... Vs>
    template<class Source, class Target>
    void graph<graph_nodes<Ts...>, nds::graph_rules<edge<Us, Vs>...>>
